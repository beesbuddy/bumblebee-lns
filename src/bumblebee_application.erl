...
-callback handle_join(
    {Network :: #network{}, Profile :: #profile{}, Device :: #device{}},
    {MAC :: binary(), RxQ :: #rxq{}},
    DevAddr :: devaddr()
) ->
    ok | {error, Error :: term()}.
-callback handle_uplink(
    {Network :: #network{}, Profile :: #profile{}, Node :: #node{}},
    {MAC :: binary(), RxQ :: #rxq{}},
    {lost, Receipt :: any()},
    Frame :: #frame{}
) ->
