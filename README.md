 ...
 * Invokes internal modules with application logic. It provides examples for:
   ...
   * [Microchip LoRa(TM) Technology Mote](http://www.microchip.com/Developmenttools/ProductDetails.aspx?PartNO=dm164138)
     (via an [external plug-in](https://github.com/gotthardp/bumblebee-demoapp))
...
[bumblebee mailing list](https://groups.google.com/forum/#!forum/bumblebee).
We will gladly assist you. If you find a bug, you may also
[add an Issue](https://github.com/gotthardp/bumblebee/issues/new).


## Documentation

The bumblebee includes all functions required to run a private LoRaWAN network.
...
The main components of the bumblebee are shown in the following figure:

![alt tag](https://raw.githubusercontent.com/gotthardp/bumblebee/master/doc/images/system-architecture.png)
...
You can integrate bumblebee with external applications using Backend
...
may offer custom REST APIs. The bumblebee is designed to be highly extensible.
...
### Troubleshooting
[![Build Status](https://travis-ci.org/gotthardp/bumblebee.svg?branch=master)](https://travis-ci.org/gotthardp/bumblebee)
...
to always use the [latest release](https://github.com/gotthardp/bumblebee/releases).
If you use the [latest sources](https://github.com/gotthardp/bumblebee/commits/master),
...
[issues](https://github.com/gotthardp/bumblebee/issues) to verify the
problem was not already reported and then
[create new issue](https://github.com/gotthardp/bumblebee/issues/new).
 ...
 * [Three reasons for creating an Open Source LoRaWan server](http://research.konicaminolta.eu/three-reasons-for-creating-an-open-source-bumblebee)
 * [LoraWAN server running on OpenWrt/LEDE](http://matchx.io/community/box/5-bumblebee-running-on-the-box)
...
Please let me know if you use the bumblebee and want to be listed here.


## Copyright and Licensing

The bumblebee is distributed under the terms of the MIT License.
See the [LICENSE](LICENSE).

Copyright (c) 2016-2019 Petr Gotthard
Copyright (c) 2026 Bumblebee contributors

### Attribution Policy for This Fork

This project is derived from the original work by Petr Gotthard and remains
licensed under MIT. Existing source files retain their original notices unless
there is a legal reason to change them.

New contributions to this fork are also licensed under MIT and should preserve
the original license text and attribution notices in distributed copies.
